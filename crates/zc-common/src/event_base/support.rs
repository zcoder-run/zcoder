...
pub(super) fn handle_send_result<E>(result: core::result::Result<(), E>, name: &'static str) -> EventBaseResult<()> {
...
pub(super) fn handle_recv_result<T, E>(result: core::result::Result<T, E>, name: &'static str) -> EventBaseResult<T> {
